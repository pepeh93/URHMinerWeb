    ...
    <section>
        ...
        <div class="container">
            <ul class="nav nav-pills nav-fill">
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() == 'users' || Request::path() == 'administrar' ? 'text-white bg-warning' : ''}}" href="{{route('user.index')}}">Usuarios</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() == 'category' ? 'text-white bg-warning' : ''}}" href="{{route('category.index')}}">Categorías</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() == 'content' ? 'text-white bg-warning' : ''}}" href="{{route('content.index')}}">Contenidos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() == 'pool' ? 'text-white bg-warning' : ''}}" href="{{route('pool.index')}}">Pools</a>
                </li>
            </ul>
        </div>
